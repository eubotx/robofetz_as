...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'detection_kalman_filter = arena_perception.detection_kalman_filter:main',
            'param_loader = arena_perception.param_loader:main',
            ...
            'train_yolo = arena_perception.2_train_yolo:main',
