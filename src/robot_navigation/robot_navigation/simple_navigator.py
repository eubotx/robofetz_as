...
class BattleBotNavigator(Node):
    def __init__(self):
        ...
        # Declare parameters - aggressive defaults
    ...
    def parameter_callback(self, params):
        """Called when parameters are updated dynamically"""
        for param in params:
            if param.name in self.get_parameters([]):
    ...
    def control_loop(self):
        ...
        try:
            ...
            # Compute distance & angle to goal
            ...
            if distance > self.position_tolerance:
                # Angular command
                angular_cmd = self.angular_kp * yaw_error + self.angular_ki * self.yaw_integral
                
                # Linear speed with angle factor
